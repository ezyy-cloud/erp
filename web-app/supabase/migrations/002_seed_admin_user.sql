...
-- Credentials: cloud.architect@ezyy.cloud / (set in Dashboard)
-- Role: super_admin
...
BEGIN
  ...
  ELSE
    RAISE WARNING 'Admin user not found in auth.users. Please create the user in Supabase Auth first (cloud.architect@ezyy.cloud)';
  END IF;
END $$;
